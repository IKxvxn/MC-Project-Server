...
const importDeckFailure = "No se pudo importar el mazo porque este no existe"
...
module.exports = {
    getMongoMessageByErrorCode, importDeckFailure, importDeckSuccess, zeroQuestionsError, quizzCreatedSuccessfully, noCardsProvided, updateCardError, updateCardSuccess, deleteCardError, deleteCardSuccess, createCardError, unknownError, createAccountSuccess, dataError, loginError, loginSuccess, tokenError, createDeckSuccess, updateDeckSucces, deleteDeckError, deleteDeckSuccess, tokenExpired, createCardSuccess
}